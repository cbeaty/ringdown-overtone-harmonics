...
class Plots:
    ...
    def plot_d_theta(
        ...
        # import theta dot
        d_arctan = np.genfromtxt(f'data{file_path[-4:]}/d_theta/peak_{label_dominant}_{label_mode}.dat', delimiter='\t')
        t_final = np.genfromtxt(f'data{file_path[-4:]}/times_fundamental.dat', delimiter='\t')[1]
        ...
        plt.savefig(f'figs{file_path[-4:]}/darctan_{label_mode}.pdf', bbox_inches="tight")
